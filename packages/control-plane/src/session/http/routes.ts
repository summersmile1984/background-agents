...
export interface SessionInternalRouteHandlers {
  ...
  commandEvent: SessionInternalRouteHandler;
  ...
  reconcilePending: SessionInternalRouteHandler;
...
export function createSessionInternalRoutes(
  ...
  return [
    ...
    { method: "POST", path: SessionInternalPaths.commandEvent, handler: handlers.commandEvent },
    ...
    {
      method: "POST",
      path: SessionInternalPaths.reconcilePending,
      handler: handlers.reconcilePending,
    },
    {
      method: "POST",
