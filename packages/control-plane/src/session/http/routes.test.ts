  ...
  it("builds the expected method/path mapping", () => {
    ...
    expect(methodPathSet).toEqual(
      new Set([
        ...
        `POST ${SessionInternalPaths.commandEvent}`,
        ...
        `POST ${SessionInternalPaths.reconcilePending}`,
        ...
        `POST ${SessionInternalPaths.runtimeError}`,
